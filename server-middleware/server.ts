...
import { ExampleResolver, WordleResolver } from './backend/resovlers'
...
db.connection.once('open', () => {
  ...
  // initExampleDatabase()
  console.log('Done init database')
})
...
const resolversArray: Resolvers<GraphQLContext>[] = [ExampleResolver, WordleResolver]
